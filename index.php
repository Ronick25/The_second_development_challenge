...
<div class="container">
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" id="edge" placeholder="number from 1 to 100">
    </div>
    <div class="form-group" class="form-control">
        <h5>Разраженность матрицы(R)</h5>
        <input type="number" class="form-control" id="rarefaction" placeholder="number from 1 to 100">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" placeholder="number from 100 to 1000(milliseconds)" id="animation_speed">
    </div>
    <div class="form-group">
        <h5>Координата начальной позиции маркера в матрице (START)</h5>
        <input type="text" class="form-control" id="start-coordinat" placeholder="Row, Col">
    </div>
    <div class="form-group">
        <h5>Координата конечной позиции маркера в матрице (END)</h5>
        <input type="text" class="form-control" id="end-coordinat" placeholder="Row, Col">
    </div>
    <div class="form-group">
    ...
    <button class="btn btn-default start-search">Начать поиск</button>
</div>
<div class="table">
    <table class="matrix"></table>
    <button class="btn btn-success continue-search">Продолжить поиск</button>
</div>
